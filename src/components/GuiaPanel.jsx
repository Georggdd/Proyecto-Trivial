    ...
    <AnimatePresence>
      {guiaAbierta && (
        ...
        >
          ...
          <button
            onClick={toggleGuia}
            className="mt-10 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded shadow block w-full"
          >
            Cerrar Guía
          </button>

          {/* Nuevo botón “Terminar juego” */}
          <button
            onClick={handleTerminar}
            className="mt-4 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded shadow block w-full"
          >
            Terminar juego
          </button>
        </motion.div>
