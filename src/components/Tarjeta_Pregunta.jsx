            ...
            <section id='tarjeta' className='bg-verdeClaro flex flex-col h-[80vh] w-[74vw] rounded-lg border-black border-[4px]'>
                ...
                <div id='contenido-tarjeta' className='flex-1 w-full flex justify-between font-lemon'>
                    ...
                    <div id='respuestas' className='w-1/2 flex flex-col items-center justify-center gap-4'>
                        <button className="w-[75%] h-20 rounded-xl flex items-center gap-4 text-nowrap bg-white pl-5 text-black text-3xl font-bold hover:bg-verdeOscuro hover:text-white transition-all"> <img className='w-[39.46px] h-[43.45px]' src="/public/assets/img/icono-queso.png" alt="" /> Estados Unidos </button>
                        <button className="w-[75%] h-20 rounded-xl flex items-center gap-4 text-nowrap bg-white pl-5 text-black text-3xl font-bold hover:bg-verdeOscuro hover:text-white transition-all"> <img className='w-[39.46px] h-[43.45px]' src="/public/assets/img/icono-queso.png" alt="" /> Unión Soviética </button>
                        <button className="w-[75%] h-20 rounded-xl flex items-center gap-4 text-nowrap bg-white pl-5 text-black text-3xl font-bold hover:bg-verdeOscuro hover:text-white transition-all"> <img className='w-[39.46px] h-[43.45px]' src="/public/assets/img/icono-queso.png" alt="" /> Alemania </button>
                        <button className="w-[75%] h-20 rounded-xl flex items-center gap-4 text-nowrap bg-white pl-5 text-black text-3xl font-bold hover:bg-verdeOscuro hover:text-white transition-all"> <img className='w-[39.46px] h-[43.45px]' src="/public/assets/img/icono-queso.png" alt="" /> China </button>
                    </div>
                </div>
            </section>
        </div>
