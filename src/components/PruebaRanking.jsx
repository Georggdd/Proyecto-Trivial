...
const PruebaRanking = () => {
    // Estado para almacenar el nombre recibido desde el formulario
    const [nombre, setNombre] = useState('');

    return (
        <>
            <h1>Formulario de Nombre</h1>
            <PruebaFormulario setNombre={setNombre} />
        ...
        */ }
                        ...
                        {/* Pasamos la función setNombre a Formulario */}
                        {nombre &&
                            <h2 className="text-center font-personalizada text-5xl"> {nombre}
                            </h2>}
