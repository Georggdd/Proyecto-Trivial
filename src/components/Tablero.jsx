...
function Tablero() {
    return (
      <div className="relative w-full h-screen">
        ...
        {/* Resto de casillas */}
        <div className="absolute top-[41%] left-[52.5%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"> <Casilla numero={1} /> </div>
        <div className="absolute top-[38.4%] left-[54.8%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"> <Casilla numero={2} /> </div>
        <div className="absolute top-[36%] left-[57%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"> <Casilla numero={3}/> </div>
        <div className="absolute top-[33.5%] left-[59.3%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"> <Casilla numero={4} /> </div>
        <div className="absolute top-[31.2%] left-[61.6%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"> <Casilla numero={5} /> </div>
        {/* */}
        <div className="absolute bottom-[41%] left-[52.5%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={6} /></div>
        <div className="absolute bottom-[38.4%] left-[54.8%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={7} /></div>
        <div className="absolute bottom-[36%] left-[57%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={8} /></div>
        <div className="absolute bottom-[33.5%] left-[59.3%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={9} /></div>
        ...
        <div className="absolute bottom-[39%] right-[54.7%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={17} /></div>
        <div className="absolute bottom-[36.5%] right-[57%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={18} /></div>
        <div className="absolute bottom-[34%] right-[59.3%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={19} /></div>
        <div className="absolute bottom-[31.7%] right-[61.6%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={20} /></div>
        {/* */}
        
        <div className="absolute top-[41%] right-[52.5%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={21} /></div>
        <div className="absolute top-[38.4%] right-[54.8%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={22} /></div>
        <div className="absolute top-[36%] right-[57%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={23} /></div>
        <div className="absolute top-[33.5%] right-[59.3%] w-[10%] -translate-x-1/2 -translate-y-1/2 z-10"><Casilla numero={24} /></div>
